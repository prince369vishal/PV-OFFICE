...
(function () {
  ...
  const dotBtns = document.querySelectorAll('#trainers-dots .trainers-dot');
  const CARD_W  = 300 + 20;
  let current   = 0;
  ...
  document.getElementById('trainers-next').addEventListener('click', () => scrollTo(current + 1));
  document.getElementById('trainers-prev').addEventListener('click', () => scrollTo(current - 1));
